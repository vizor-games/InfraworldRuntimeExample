...
#ifndef PROTOBUF_INCLUDED_vizor_5fdemonstration_2eproto
#define PROTOBUF_INCLUDED_vizor_5fdemonstration_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_vizor_5fdemonstration_2eproto 
...
namespace google {
namespace protobuf {
template<> ::vizor_proto_demostration::HelloRequest* Arena::CreateMaybeMessage<::vizor_proto_demostration::HelloRequest>(Arena*);
template<> ::vizor_proto_demostration::HelloResponse* Arena::CreateMaybeMessage<::vizor_proto_demostration::HelloResponse>(Arena*);
template<> ::vizor_proto_demostration::ServerTimeRequest* Arena::CreateMaybeMessage<::vizor_proto_demostration::ServerTimeRequest>(Arena*);
template<> ::vizor_proto_demostration::ServerTimeResponse* Arena::CreateMaybeMessage<::vizor_proto_demostration::ServerTimeResponse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace vizor_proto_demostration {
...
class ServerTimeRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vizor_proto_demostration.ServerTimeRequest) */ {
 public:
  ...
  inline ServerTimeRequest* New() const final {
    return CreateMaybeMessage<ServerTimeRequest>(NULL);
  }

  ServerTimeRequest* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ServerTimeRequest>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class ServerTimeResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:vizor_proto_demostration.ServerTimeResponse) */ {
 public:
  ...
  #if LANG_CXX11
  ServerTimeResponse(ServerTimeResponse&& from) noexcept
    : ServerTimeResponse() {
    *this = ::std::move(from);
  }

  inline ServerTimeResponse& operator=(ServerTimeResponse&& from) noexcept {
    if (GetArenaNoVirtual() == from.GetArenaNoVirtual()) {
      if (this != &from) InternalSwap(&from);
    } else {
      CopyFrom(from);
  ...
  friend void swap(ServerTimeResponse& a, ServerTimeResponse& b) {
    a.Swap(&b);
  }

  // implements Message ----------------------------------------------

  inline ServerTimeResponse* New() const final {
    return CreateMaybeMessage<ServerTimeResponse>(NULL);
  }

  ServerTimeResponse* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<ServerTimeResponse>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
// int64 unixTimeStamp = 1;
inline void ServerTimeResponse::clear_unixtimestamp() {
  unixtimestamp_ = GOOGLE_LONGLONG(0);
}
inline ::google::protobuf::int64 ServerTimeResponse::unixtimestamp() const {
  // @@protoc_insertion_point(field_get:vizor_proto_demostration.ServerTimeResponse.unixTimeStamp)
  return unixtimestamp_;
}
inline void ServerTimeResponse::set_unixtimestamp(::google::protobuf::int64 value) {
  
  unixtimestamp_ = value;
  // @@protoc_insertion_point(field_set:vizor_proto_demostration.ServerTimeResponse.unixTimeStamp)
}
...
#endif  // PROTOBUF_INCLUDED_vizor_5fdemonstration_2eproto
